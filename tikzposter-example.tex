 ...
 \begin{document}
     ...
     \begin{columns}%blocks will be placed into columns
         ...
         \block[roundedcorners=40]{Creating the document}{
             ...
             \begin{quote}
                 \texttt{\bs documentclass[25pt, a0paper, landscape, margin=10mm, innermargin=15mm,
      ...
      \begin{tikzpicture}
        ...
        \node (ircode)[right=of sbmllogo, align=left] {
        ...
        \node (machinecode)[right=of ircode, align=left] {
        \small\texttt{  7c2b20:  55                    push   \%rbp}\\
        \small\texttt{  7c2b21: 48 89 e5              mov    \%rsp,\%rbp}\\
%         \small\texttt{  7c2b24: e8 77 ff ff ff        callq  7c2aa0 <\_\_cxx\_global\_var\_init>}\\
%         \small\texttt{  7c2b29: e8 b2 ff ff ff        callq  7c2ae0 <\_\_cxx\_global\_var\_init1>}\\
        \small\texttt{  7c2b2e: 5d                    pop    \%rbp}\\
        \small\texttt{  7c2b2f: c3                    retq}
        };
        \node (simplot)[right=of machinecode] {
          \begin{tikzpicture}
            \begin{axis}[
              width=0.10\textwidth,
