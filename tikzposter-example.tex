...
%          \block[titlewidthscale=.8,bodywidthscale=.9,titleoffsety=9.5mm,bodyoffsety=9mm]{Changing the Poster's Appearance}{
          \block{Acknowledgments and Funding Sources}{
            \begin{tikzfigure}
            \centering
            \includegraphics[scale=0.4]{nigms.png}
            \hspace{8em}
            ...
            We also acknowledge Totte Karlsson for the original C\# to C++ translation, C compiler backend and C API, Stanley Gu for testing the library as a web service, Lucian Smith for developing part of the test suite, and Michael Galdzicki for writing detailed build instructions and testing for developers.
